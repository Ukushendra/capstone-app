...
function AdminDashboard() {
  ...
  const fetchCampaignStats = async () => {
    try {
      const res = await axios.get("/api/analytics/campaign-stats");
  ...
  const promoteUser = async (id) => {
    await axios.put(`/api/admin/users/promote/${id}`, {}, { headers });
    fetchData();
  };
  ...
  const createCampaign = async (e) => {
    ...
    try {
      await axios.post("/api/admin/campaigns", form, { headers });
