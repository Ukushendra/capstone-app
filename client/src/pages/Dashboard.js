...
const bookmarkCampaign = async (campaignId) => {
  try {
    await axios.post("/api/campaign/bookmark", { campaignId, userId });
...
const completeCampaign = async (campaignId) => {
  try {
    await axios.post("/api/campaign/complete", { campaignId, userId });
...
const rateCampaign = async (campaignId) => {
  try {
    await axios.post("/api/campaign/rate", { campaignId, userId, rating: 5 });
